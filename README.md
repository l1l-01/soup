...
- **Event-Tracker (Vanilla JavaScript)**: Capturing user interactions
...
- **Performance Optimization**: Throttling and memory management

## Why "Soup" ?
Because like a good soup, this project: Mixes multiple ingredients.

> [!IMPORTANT]
> **Important Note**: Currently, you need to manually copy event-tracker/main.js to proxy/public/ for the proxy to serve the latest tracking script. This will be automated in the future.
